...
char * stream_format_table[ASTREAM_CNT] = {
    ...
    [ASTREAM_CAPTURE_USB_DEVICE]     = "AUDIO_FORMAT_PCM_16_BIT",
...
char * stream_channel_table[ASTREAM_CNT] = {
    ...
    [ASTREAM_CAPTURE_USB_DEVICE]     = "AUDIO_CHANNEL_IN_MONO|AUDIO_CHANNEL_IN_STEREO",
...
char * stream_rate_table[ASTREAM_CNT] = {
    ...
    [ASTREAM_CAPTURE_USB_DEVICE]     = "48000",
