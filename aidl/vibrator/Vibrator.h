...
class Vibrator : public BnVibrator {
  public:
    ...
    ndk::ScopedAStatus getPrimitiveDuration(CompositePrimitive in_primitive, int32_t* _aidl_return) override;
    ndk::ScopedAStatus compose(const std::vector<CompositeEffect>& in_composite, const std::shared_ptr<IVibratorCallback>& in_callback) override;
