...
class Vibrator : public BnVibrator {
  public:
    ...
    ndk::ScopedAStatus composePrimitives(const std::vector<CompositeEffect>& composite, const std::shared_ptr<IVibratorCallback>& callback) override;
    ...
    ndk::ScopedAStatus alwaysOnIsSupported(bool* _aidl_return) override;
